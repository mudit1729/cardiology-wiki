...
## Clinical Question
In patients with acute coronary syndrome (ACS) and increased risk of contrast-induced acute kidney injury (CI-AKI), does ultra-low contrast percutaneous coronary intervention (ULC-PCI) reduce the incidence of CI-AKI compared to conventional PCI?

## PICO

| Population | Intervention | Comparator | Outcome |
|------------|--------------|------------|---------|
| 82 ACS patients with eGFR <60 mL/min/1.73m² and moderate-to-very high pre-procedural CI-AKI risk (Maioli risk score) undergoing PCI | Ultra-low contrast PCI (contrast volume ≤ patient's eGFR; CV/eGFR ≤1:1) | Conventional PCI (contrast volume ≤ 3× patient's eGFR; CV/eGFR ≤3:1) | Primary: CI-AKI within 72 hours (≥0.5 mg/dL or ≥25% rise in serum creatinine, or urine output <0.5 mL/kg/h) |

## Key Results
- **Primary outcome (CI-AKI):** 0% in ULC-PCI vs 17.1% in conventional PCI (p = 0.012).
- **Contrast volume:** 41.02 ± 9.8 mL in ULC-PCI vs 112.54 ± 25.18 mL in conventional PCI (p < 0.0001).
- **CV/eGFR ratio:** 0.976 ± 0.08 in ULC-PCI vs 2.68 ± 0.35 in conventional PCI (p < 0.0001).
- **CI-AKI in very high-risk subgroup:** 0% (0/10) in ULC-PCI vs 60% (3/5) in conventional PCI (p = 0.022).
- **CI-AKI in high + very high-risk groups:** 0% (0/23) in ULC-PCI vs 23% (6/26) in conventional PCI (p = 0.024).
- **Secondary outcomes at 30 days:** Re-hospitalization for heart failure was 0% in ULC-PCI vs 7.3% in conventional PCI (p = 0.241, not significant).
- **Need for dialysis:** 0% in ULC-PCI vs 2% (1 patient) in conventional PCI (p = 1.0, not significant).
- **Death:** 0% in ULC-PCI vs 2% (1 patient) in conventional PCI (p = 1.0, not significant).
- **eGFR at day 3:** 48.58 ± 12.38 mL/min in ULC-PCI vs 41.4 ± 11.56 mL/min in conventional PCI (p = 0.008).
...
- The study excluded STEMI primary PCI and chronic total occlusion (CTO) lesions, so results should not be extrapolated to these populations.
- As a single-center, single-operator study, widespread applicability remains unvalidated.
...
- Contrast dilution (1:1 with saline) reduces both cost and nephrotoxic load.
- A 30-day follow-up is practical for Indian outpatient settings.

## Related Trials
- Currently, no directly related trials are referenced in this summary. Further connections to studies on contrast minimization or CI-AKI prevention in ACS patients with renal dysfunction may be explored in future updates.