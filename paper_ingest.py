...
def _summary_prompt(ocr_md: str, metadata: dict) -> str:
    ...
    return (
        f"You are summarizing a research paper for Cardio Wiki, an interventional "
        f"cardiology reference. Write for a busy cardiologist — be precise and concise.\n\n"
        f"Paper: {title}\n"
        f"Authors: {authors}\n"
        ...
        f"| **Population** | Adults with rheumatic MV disease and persistent AF undergoing surgery |\n\n"
        f"## Key Results\n"
        ...
        f"- Do not add unrelated cardiology content not in the paper.\n\n"
        f"--- OCR ---\n{ocr_md[:120000]}"
    )
